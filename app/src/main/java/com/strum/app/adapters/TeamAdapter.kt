...
class TeamAdapter(var context: Context, var teamMembList: List<User>, var origMembCount: Int): RecyclerView.Adapter<TeamAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        if(teamMembList[position].username!="END"){
